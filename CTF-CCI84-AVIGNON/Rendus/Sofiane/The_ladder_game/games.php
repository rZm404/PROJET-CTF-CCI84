...
// Récupération de la variable d'entrée "file" de l'URL
$file = $_GET['file'];

// Concaténation de la variable d'entrée avec le chemin de base
$path = '/var/www/html/' . $file;

// Normalisation du chemin pour éviter les erreurs de chemins relatifs
$path = realpath($path);
